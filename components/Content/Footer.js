    ...
    <>
      <div className={"bg-footer bg-cover bg-no-repeat bg-center "}>
        ...
        <div className={"container mx-auto pt-5 pb-20"}>
          ...
          <div className={"flex justify-center items-center"} data-aos="flip-left" data-aos-duration="2000">
            <h1
              className={
          ...
          <div className={"flex justify-center items-center content-center "} data-aos="fade-in" data-aos-duration="3000">
            <h1
              className={
                "md:text-6xl text-center text-5xl mb-0 font-medium text-white leading-relaxed font-curs"
              }
          ...
          <div className={"flex justify-center items-center content-center "} data-aos="flip-right" data-aos-duration="2000">
            <h1
              className={
